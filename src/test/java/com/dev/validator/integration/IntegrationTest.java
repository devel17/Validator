 ...
 */
package com.dev.validator.integration;
...
import com.dev.validator.service.CountryCodeValidateService;
...
public class IntegrationTest {
    ...
    @Test
    @Sql("classpath:/data-mysql.sql")
    public void testBelarusNumberWeb() throws ValidateException {
        List<CountryCode> codes = validator.validate("375291112233");
        assertThat(codes).extracting(CountryCode::getCountry).contains("Belarus");
    }
